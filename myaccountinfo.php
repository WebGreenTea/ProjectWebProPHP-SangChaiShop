        ...
        <form action="updateUserData.php" method="post">
            <?php if (isset($_SESSION['error'])) : ?>
                <div id="error">
                    ...
                    echo "<script>alert('!บันทึกข้อมูลไม่สำเร็จ: $error')</script>";
            ...
            <div class="mb-3 row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="username" name="username" maxlength="15" required value="<?php echo $userData['username'] ?>" onfocus="disableerr()">
                </div>
                <div class="col-md-6">
                    <label for="Email" class="form-label">Email</label>
                    <input type="email" class="form-control" id="Email" name="Email" maxlength="40" required value="<?php echo $userData['email'] ?>" onfocus="disableerr()">
                </div>
            </div>
            <div class="mb-3 row">
                <div class="col-md-6">
                    <label for="name" class="form-label">ชื่อ</label>
                    <input type="text" class="form-control" id="name" name="name" maxlength="35" required value="<?php echo $userData['name'] ?>" onfocus="disableerr()">
                </div>
                <div class="col-md-6">
                    <label for="lastname" class="form-label">นามสกุล</label>
                    <input type="text" class="form-control" id="lastname" name="lastname" maxlength="35" required value="<?php echo $userData['lastname'] ?>" onfocus="disableerr()">
                </div>
            </div>
            <div class="mb-3 row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="PhoneNumber" name="PhoneNumber" maxlength="10" required value="<?php echo "0" . $userData['PhonNumber'] ?>" onfocus="disableerr()">
                </div>
            </div>
            <div class="mb-3">
                <label class="form-label for=" adress">ที่อยู่(สำหรับการจัดส่งสินค้า)</label>
                <textarea class="form-control" id="adress" name="address" maxlength="300" required onfocus="disableerr()"><?php echo $userData['address'] ?></textarea>
            </div>
